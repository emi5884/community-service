...
#### 分配方法：カテゴリ一覧画面orプロジェクト画面の「サポートする」ボタンをクリック<br>
...
![distribute2](https://github.com/emi5884/community-service/assets/98724087/811eed61-d5e3-4112-81a8-ef0e72537f97)<br>
...
### Q2 アプリに参加している団体は全て寄付金の分配対象か?　<br><br>
...
リサイクルショップや善意銀行でのアルバイトを通して、企業の抱えている未活用資産の可能性と有効活用したい意向を知りました。
...
#### 現金の寄付<br>
寄付金は全て非営利団体やソーシャルビジネスの活動費に分配されるため、<br>
...
```
インフォ：自治体情報の共有
例) 急を要する情報の配信(高齢者やペットの行方不明情報等) 、市民団体の活動情報、地域のスモールビジネスのオープン情報、市報

コミュニケーション：市政への参加機会の提供
例) パブリックコメント、住民アンケート

マップ：市内の位置情報
例) 医療施設、避難場所など災害発生時に重要な場所、(シェア画面の)スペースやイベント開催地、コミュニティの活動場所等
```
<br>
...
寄付金は全てファンド画面でコミュニティに分配され、アプリの運営費は広告収益を活用する想定です。<br>
広告は、インスタグラム広告のようにアプリから収集されるデータをもとにパーソナライズされた広告や検索ワードにヒットした広告を想定しています。<br><br>

※検索ワードにヒットした広告イメージ<br>
地域のスモールビジネスの広告や今後の世界動向を踏まえ3つのP(planet, people, profit ※14)に配慮したプロダクト等
...
※参考：ウィスラーコミュニティサービス (スリフトショップの売上をコミュニティのために活用 ※12)<br>
...
![kutikomi_3](https://github.com/emi5884/community-service/assets/98724087/d7f8a467-b6ff-427a-8db4-66d2d7276667)
