#### ※ 画像内の文字が読みづらい場合は、画像をクリックしていただくと別タブで拡大画像が確認できます。<br><br>
...
このアプリは、団体の活動をサポートすることで(団体と市民を繋ぐサポートや活動費のサポート等)、地域社会の発展と住民の充実した生活に貢献することを目指しています。<br><br>
...
※善意銀行(個人や企業からの現金, 物品, 体験等の寄付を必要としている団体につなげる活動をしている社会福祉法人)を参考にしています。(※4)<br><br>
...
※ クラシファイドサイト(craigslist)を参考にしています。(※5)<br><br>
...
#### ALLイメージ<br>
※検索キーワード「犬」<br><br>
![all](https://github.com/emi5884/community-service/assets/98724087/fd4b1e75-607d-497a-969e-1904eed147d3)

<br>

---------------

### ファンド画面：寄付金の再分配を行う画面<br>
...
#### 再分配イメージ<br>
![support_2_2](https://github.com/emi5884/community-service/assets/98724087/c5d59777-d048-43a8-a08f-673288805913)
...
情報提供方法①：相談窓口(チャットボット)での情報提供<br><br>
![ai](https://github.com/emi5884/community-service/assets/98724087/654fbe5c-33df-4ccd-abd0-27b3e9189181)

情報提供方法②：GNHのアンケート結果のフォロー (Noと回答した場合は、相談画面を表示等) <br>
ウィスラーコミュニティサービスのアウトリーチサービスを参考にしています。(※8)<br><br>
...
ウィスラーのまちづくりの指標とブータンのGNHを参考にしています。(※9)<br><br>
...
再分配の意思決定を市民参加型にすることで、多くの人が課題と感じていることには多くの資金が分配される一方、少数の人が感じている課題も見過ごされず資金が分配されることを目指しています。<br><br>

※ イメージ(※10)<br>
課題解決のために活動する団体の活動費を支援することで活動内容が充実し、支援者にとっても実現したい町に近づくイメージです。<br>
(下の例の場合は、団体を支援することで遊び場が増えたり、保護される動物が増えることが期待されます。) <br><br>
![distribute](https://github.com/emi5884/community-service/assets/98724087/8fe5a8e8-2175-44e6-a519-c114fbe70f4c)<br><br>
#### ※ 再分配の内訳公開<br>
「サポートする」ボタンがクリックされた数に応じて分配比率が変動<br><br>

![support_3_2](https://github.com/emi5884/community-service/assets/98724087/4c3cb598-5aa4-4b0d-93e7-72cad660505b)

----------

### Q2 シェア画面に表示されているものは有料か?　<br><br>
...
経済状況に関わらず様々な選択肢を持つことを支援し、市民の可能性が開花することに貢献したいと考えています。<br>

----------

### Q3 寄付金以外のインプットはあるか？<br><br>

寄付金以外に以下の3つのインプットを想定しています。<br>
1はアプリの運営費に活用され、寄付から生まれる2&3の資金は再分配に活用される想定です。<br><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;沖縄の共同売店 (コミュニティで運営し、利益をコミュニティのために活用) を参考にしています。(※12)<br>
...
リサイクルショップや善意銀行でのアルバイトを通して、企業の抱えている未活用資産の可能性と有効活用したい意向を知りました。<br>
...
&nbsp;&nbsp;&nbsp;ウィスラーコミュニティーサービス (スリフトショップの売上をコミュニティのために活用) を参考にしています。(※13)<br><br>
...
```
インフォ：自治体情報の共有
例) 急を要する情報の配信(高齢者やペットの行方不明情報等) 、市報、ゴミカレンダー、市民活動情報
...
![profile](https://github.com/emi5884/community-service/assets/98724087/b275703f-843a-4bfb-8f4a-337195a302c0)

----------

### Q9 寄付が少ないと言われる日本で寄付が集まるのか？<br><br>

善意銀行でアルバイトをしていたときに企業の方が「寄付したいものはあるけど、どこに寄付をすればいいのか分からなかった」とおっしゃていたことが印象に残っています。<br>
アプリがウィスラーコミュニティファンデーション(※14)のように寄付を一元的に受け付ける寄付の総合窓口のような存在になることで寄付が集まりやすくなることを期待しています。<br>

----------

### Q10 アプリの想定ユーザーは?　<br><br>
